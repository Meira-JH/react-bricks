...
import { Plain, types, useAdminContext } from 'react-bricks/frontend'
      ...
      <input
        ...
        className={classNames(
          ...
          errors[fieldName]
            ...
            : 'border-gray-900 dark:border-gray-500 focus:border-sky-500 dark:focus:border-white focus:ring-sky-200 dark:focus:ring-white/20'
        )}
        {...registerAttributes}
      />
